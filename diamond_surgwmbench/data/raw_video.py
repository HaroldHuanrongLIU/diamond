...
class SurgWMBenchRawVideoDataset(Dataset):
    """Load source-video windows for optional world-model pretraining."""
    ...
    def _source_video_entries(self) -> list[dict[str, str]]:
        ...
        for entry in raw_entries:
            ...
            if manifest_path is not None and source_split is not None and self.split != "all" and str(source_split) != self.split:
                continue
