"""Small deterministic image transforms for SurgWMBench loaders."""
...
def load_rgb_frame(
    ...
    *,
    ...
    The returned original size is ``(height, width)``. Target coordinates are
    not resized here; normalized coordinates remain valid after image resizing.
    """
